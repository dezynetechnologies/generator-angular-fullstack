  ...
  grunt.initConfig({
    ...
    wiredep: {
      target: {
        ...
        exclude: [/bootstrap-sass-official/, /bootstrap.js/,/material.js/,/ripples.js/, '/json3/', '/es5-shim/'<% if(!filters.css) { %>, /bootstrap.css/, /font-awesome.css/, /material.css/, /ripples.css/ <% } %>]
      }
    },
